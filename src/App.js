...
function App() {
  ...
  useEffect(() => {
    ...
    const elements = document.querySelectorAll(".floating-fade-line");
      ...
      <div className="container px-4 py-5" id="icon-grid">
        ...
        <div className="row g-4 py-4">
          ...
          <div className="col-md-4 d-flex align-items-start">
            ...
            <div>
              <h3 className="fw-bold mb-0 fs-4 text-body-emphasis ">Content Campaigns</h3>
              <p>Newsletters, editorials, surveys—all crafted with purpose.</p>
            </div>
          </div>

          <div className="col-md-4 d-flex align-items-start">
            <i className="fas fa-chart-line text-body-secondary flex-shrink-0 me-3 turq" style={{ fontSize: "1.75em" }}></i>
            <div>
              <h3 className="fw-bold mb-0 fs-4 text-body-emphasis">Analytics & Strategy</h3>
              <p>Data-driven insights to steer your brand to success.</p>
            </div>
          </div>
        </div>
      </div>
...
<section id="call-to-action" className="call-to-action section dark-background">
  <div className="container">
    <div className="row justify-content-center">
      <div className="col-xl-10 text-center">
        <div className="fade-in-box">
          <h2 className="highlighted-title floating-fade-line">What Sets Us Apart</h2>
          <p className="floating-fade-line">Data-Driven Approach, Precision Targeting & Strategy, Custom Creative & Visual Excellence, 
            Results that Speak for Themselves,  Let’s build something extraordinary.</p>
    ...
    <div class="container section-title aos-init aos-animate center-text" data-aos="fade-up">
          <h2 class="turq center-text">Contact Us</h2>
              ...
              <div class="info-wrap">
                <div class="info-item d-flex aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
                  <div>
                    ...
                    <p> <i class="bi bi-geo-alt flex-shrink-0"> </i>6 Sturdee Avenue, Rosebank,
                ...
                <div class="info-item d-flex aos-init aos-animate" data-aos="fade-up" data-aos-delay="300">
                  <div>
                    ...
                    <p> <i class="bi bi-telephone flex-shrink-0"></i> +27 11 912 1000</p>
                  </div>
                </div>
                ...
                <div class="info-item d-flex aos-init aos-animate" data-aos="fade-up" data-aos-delay="400">
                  <div>
                    ...
                    <p> <i class="bi bi-envelope flex-shrink-0"></i> info@example.com</p>
                  </div>
                </div>
